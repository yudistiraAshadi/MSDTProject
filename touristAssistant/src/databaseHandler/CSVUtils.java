...
/*****************************************************************
 * A class to parse (translate) Comma Separated Value (CSV) file 
 * into a list of strings. Since the basic of CSV is using comma 
 * as the separator, we define ',' as the default separator,
 * but the programmer can change it any time.
*****************************************************************/
